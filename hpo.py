...
def train(model, train_loader, validation_loader, criterion, optimizer, use_cuda):
    epochs=30
    best_loss=1e6
...
def main(args):
    ...
    model=train(model, train_loader, validation_loader, criterion, optimizer, use_cuda)
